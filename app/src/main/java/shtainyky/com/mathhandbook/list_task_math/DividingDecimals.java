...
public class DividingDecimals extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dividing_decimals);
        initElements();
        initToolBar();
    }
    @Override
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.find2:
                ...
                fractionsRes = CommonFraction.dividingFractions(fractionOne, fractionTwo);
    ...
    private void initToolBar() {
        ...
        toolBar.setTitle(R.string.list_math_4);
